<template>
    <div class="d-flex justify-content-end mb-4" v-if="message.type === 'bot'">
        <div class="msg_container_send bot-notification" data-toggle="tooltip" data-placement="top"
    ...
    <div
        ...
        <div class="msg-actions d-flex mr-2">
            <div class="d-flex align-items-center">
                <i class="fal fa-grin-alt" data-toggle="tooltip" data-placement="top" title="React"
                   @click="showEmoji"></i>
            </div>
        </div>
        <div
    ...
    >
        ...
        <div class="msg_container" :class="{'bg-gray': message.receiver}" data-toggle="tooltip" data-placement="top"
             :title="message.created_at | toLocalTime">
            <div v-html="highlight"></div>
            <Reaction
                v-if="message.reactions.length"
